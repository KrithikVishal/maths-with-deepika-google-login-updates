...
export default function ForMothersPage() {
  return (
    <PageShell>
      <a href="#join-m2m" className="focus-ring fixed bottom-4 left-1/2 z-50 max-w-[calc(100vw-2rem)] -translate-x-1/2 rounded-full bg-coral px-5 py-3 text-center text-sm font-bold text-white shadow-soft transition hover:brightness-95">
        Join M2M Program
      </a>
      ...
      <section className="relative overflow-hidden bg-white">
        <div className="mx-auto grid max-w-7xl items-center gap-10 px-4 py-12 sm:px-6 sm:py-14 lg:min-h-[calc(100vh-72px)] lg:grid-cols-[1fr_0.9fr] lg:px-8 lg:py-16">
          <div>
            ...
            <h1 className="max-w-3xl text-3xl font-bold leading-[1.08] text-blueDeep sm:text-4xl lg:text-[2.35rem] lg:leading-[1.05]">M2M – Mom to Math Mentor Model</h1>
            <p className="mt-5 max-w-[42rem] text-xl font-bold leading-8 text-[#111827]">Learn Vedic Maths. Build teaching confidence. Start your journey as a Maths Mentor.</p>
            ...
            <div className="mt-6">
              <p className="inline-flex rounded-full border border-[#D8E2F3] bg-[#EAF3FF] px-4 py-2 text-sm font-semibold text-blueDeep shadow-[0_10px_24px_rgba(16,42,86,0.08)]">
                Self-paced learning + weekly live revision + 1 year WhatsApp support from me
              </p>
              <Button href="#join-m2m" icon className="mt-5">Join M2M Program</Button>
            </div>
          </div>
          <div className="relative min-h-[320px] lg:min-h-[440px]">
            <div className="pointer-events-none absolute -right-8 top-8 h-48 w-56 rounded-[42%_58%_54%_46%] bg-babyBlue/70" aria-hidden="true" />
            <div className="pointer-events-none absolute bottom-4 left-4 h-32 w-44 rounded-[60%_40%_48%_52%] bg-lightPeach/80" aria-hidden="true" />
            <svg className="pointer-events-none absolute right-2 top-2 h-16 w-16 rotate-12 opacity-55" viewBox="0 0 62 58" fill="none" aria-hidden="true">
            ...
            <svg className="pointer-events-none absolute left-2 top-16 h-16 w-20 -rotate-6 opacity-45" viewBox="0 0 92 72" fill="none" aria-hidden="true">
            ...
            <svg className="pointer-events-none absolute bottom-7 right-8 h-16 w-16 -rotate-6 opacity-45" viewBox="0 0 82 92" fill="none" aria-hidden="true">
            ...
            <svg className="pointer-events-none absolute bottom-16 left-8 h-14 w-16 rotate-6 opacity-45" viewBox="0 0 96 78" fill="none" aria-hidden="true">
            ...
            <div className="relative z-10 grid min-h-[300px] place-items-center rounded-[2rem] border border-dashed border-borderSoft bg-white/55 p-8 text-center shadow-soft backdrop-blur-sm lg:min-h-[420px]">
              <p className="rounded-full bg-beige/85 px-5 py-3 text-sm font-bold text-blueDeep">Illustration placeholder</p>
            </div>
          </div>
        </div>
      </section>

      <Section tone="beige" eyebrow="Right fit" title="Is This Program for You?">
        <div className="grid gap-6 lg:grid-cols-[0.9fr_1.1fr]">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {[
              ...
              <div key={line} className="rounded-soft border border-borderSoft bg-white p-5 shadow-soft">
        ...
        <div className="mt-6 rounded-soft bg-white p-6 shadow-soft">
          <p className="mx-auto max-w-4xl text-center text-base leading-8 text-ink/75">This program is for you if you want to learn from the basics, practise with structure, get support when you feel stuck, and slowly build the confidence to teach children.</p>
          <p className="mt-4 text-center text-xl font-bold text-blueDeep">M2M will help you take that first step from “Can I?” to “Yes, I can.”</p>
        </div>
      </Section>

      <Section eyebrow="Syllabus" title="What You Will Learn Inside M2M" text="Inside M2M, you will learn Vedic Maths from the foundation level to advanced techniques.">
        <Accordion
      ...
      <Section tone="beige" eyebrow="Inside the program" title="What You Get Inside the Program">
        <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-4">
          {programFeatures.map((feature) => {
            const Icon = feature.icon;
            return (
              <div key={feature.title} className="rounded-soft border border-borderSoft bg-white p-5 shadow-soft">
      ...
      <Section eyebrow="Duration" title="Program Duration" text="Learn at your own pace">
  <div className="rounded-[2rem] bg-white p-6 shadow-soft md:p-8 lg:p-10">
    <div className="rounded-[1.75rem] border border-borderSoft bg-white p-6 shadow-sm md:p-8">
  <div className="grid gap-4 md:grid-cols-2">
    ...
    <div className="mt-6 grid gap-4 lg:grid-cols-3">
      ...
      <div className="rounded-[1.75rem] bg-blueDeep p-6 text-white shadow-soft md:p-7">
        ...
        <p className="mt-3 text-3xl font-bold leading-tight sm:text-4xl lg:text-5xl">1–3 months</p>
      ...
      <Section tone="beige" eyebrow="Certificate" title="Certification Process">
      ...
      <Section eyebrow="Founder note" title="Why I Created M2M?">
        <div className="rounded-[2rem] bg-white p-6 shadow-soft md:p-8 lg:p-10">
  <div className="grid gap-6 lg:grid-cols-[0.82fr_1.18fr] lg:items-start">
    ...
    <div className="grid gap-4 self-center sm:grid-cols-2 lg:auto-rows-min">
      ...
      <div className="rounded-[1.5rem] border border-borderSoft bg-white p-5 shadow-sm">
        <p className="text-sm font-bold uppercase tracking-[0.14em] text-coral">
          Lost confidence
        </p>
  ...
  <div className="mt-6 rounded-[1.75rem] bg-blueDeep p-6 text-white shadow-soft">
    ...
    <p className="mt-3 text-xl font-bold leading-8 md:text-2xl">
      ...
      <Section tone="beige" eyebrow="Difference" title="What Makes M2M Different?">
      ...
      <Section eyebrow="Stories" title="Real Stories from M2M Moms" text="Mothers are not just learning. They are slowly stepping into confidence.">
        <p className="mx-auto max-w-3xl text-center text-base leading-8 text-ink/75">A few real messages from mothers who joined M2M and started seeing their confidence grow.</p>
        ...
        <div className="mt-8 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
          {m2mTestimonials.map((src, index) => (
            <div key={src} className="overflow-hidden rounded-[1.5rem] bg-white shadow-soft ring-1 ring-borderSoft">
        ...
        <div className="mt-6 rounded-soft bg-white p-6 text-center shadow-soft">
          <p className="mx-auto max-w-3xl text-lg font-bold leading-8 text-blueDeep">Every message from a learner who says, “I finally started teaching,” reminds me why I created this program.</p>
          <Button href="#join-m2m" className="mt-5">I’m Ready to Learn Vedic Maths</Button>
        </div>
      </Section>

      <Section tone="beige" eyebrow="FAQ" title="FAQ Section">
        <Accordion items={faqs.map(([title, answer]) => ({ title, content: <p>{answer}</p> }))} />
      </Section>

      <Section eyebrow="Join" title="Ready to start your journey from Mom to Math Mentor?">
        <div id="join-m2m" className="rounded-[2rem] bg-white p-6 text-center shadow-soft md:p-8">
          <div className="mx-auto max-w-3xl space-y-5 text-base leading-8 text-ink/75">
